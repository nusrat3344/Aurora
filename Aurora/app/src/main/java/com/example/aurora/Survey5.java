...
public class Survey5 extends AppCompatActivity {
    ...
    String question6="I found it hard to calm down after something upset me";
    int sum,temp ;
    String s,t;
    Button next;
    String cquestion5,cquestionnum;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cquestion5 = intent.getExtras().getString("cquestion5");
        sum = intent.getExtras().getInt("csum");
        cquestionnum = intent.getExtras().getString("cquestionnum5");

        title_text = findViewById(R.id.titleText5);
        title_text.setText(cquestionnum);
        title_text.setVisibility(View.VISIBLE);

        cquestion_set = findViewById(R.id.questiontext5);
        cquestion_set.setText(cquestion5);
...
//                startActivity(intent);
                    if(condition.equals("clicked")) {
                        sum = sum + temp;
                        Intent intent = new Intent(getApplicationContext(), Survey6.class);
                        intent.putExtra("cquestion6", question6);
                        intent.putExtra("cquestionnum6", "Question6");
                        intent.putExtra("csum", sum);
                        startActivity(intent);
                    }
                    else{
                        Toast.makeText(Survey5.this,condition,Toast.LENGTH_SHORT).show();
                    }
                }
            });
