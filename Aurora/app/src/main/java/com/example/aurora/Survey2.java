...
public class Survey2 extends AppCompatActivity {
    ...
    String question3="I felt that life was meaningless";
    int sum,temp ;
    String s,t;
    Button next;
    String cquestion2,cquestionnum;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cquestion2 = intent.getExtras().getString("cquestion2");
        sum = intent.getExtras().getInt("csum");
        cquestionnum = intent.getExtras().getString("cquestionnum");

        title_text = findViewById(R.id.titleText2);
        title_text.setText(cquestionnum);
        title_text.setVisibility(View.VISIBLE);

        cquestion_set = findViewById(R.id.questiontext2);
        cquestion_set.setText(cquestion2);
...
//                startActivity(intent);
                    if(condition.equals("clicked")){
                        ...
                        intent.putExtra("cquestion3", question3);
                        intent.putExtra("csum", sum);
                        intent.putExtra("cquestionnum3", "Question3");
                        startActivity(intent);
                    }
                    else{
                        Toast.makeText(Survey2.this,condition,Toast.LENGTH_SHORT).show();
                    }
                }
            });
